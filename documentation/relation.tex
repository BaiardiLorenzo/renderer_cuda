...
\begin{document}
    ...
    \lstinputlisting[language=c++, firstline=70, lastline=95,label={lst:sequential-code}]{../src/renderer.cu}
    ...
    \lstinputlisting[language=c++, firstline=34, lastline=67, label={lst:parallel-gen}]{../src/renderer.cu}
    ...
    \lstinputlisting[language=c++, firstline=98, lastline=123, label={lst:parallel-code}]{../src/renderer.cu}
    ...
    \lstinputlisting[language=c++, firstline=150, lastline=153,label={lst:cuda-grid}]{../src/renderer.cu}
    \lstinputlisting[language=c++, firstline=177, lastline=197,label={lst:cuda-code}]{../src/renderer.cu}
